...
The system SHALL use the following channel names, and no others, for R0 fan-out.

- `room:{conversationId}` — events for room conversations
- `dm:{conversationId}` — events for DM conversations
