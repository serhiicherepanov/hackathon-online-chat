...
- `chat-ui`: tighten conversation-row, composer, message-highlight, message-action, and inline-edit interaction requirements for a denser, more stable chat surface.
...
- Likely dependency impact includes adding a maintained clipboard utility for click-to-copy behavior.
